...
wrong_input_message = "Restart the game and enter the correct information as provided."
...
# All comments above on the first set of codes for "CAVE" option applies to this set "RIVER" option
        ...
        if decision_river == "SWIM":
            ...
            decision_river3 = input("With the raft, SAIL ACCROSS or FOLLOW SHORE? ").upper().strip()
            print(f"Treasure Hunter chose to {decision_river3}")
            if decision_river3 == "SAIL ACCROSS":
...
if game_path != "CAVE" or game_path != "RIVER" or game_path != "OLD TOWER":
